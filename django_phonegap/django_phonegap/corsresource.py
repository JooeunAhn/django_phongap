"""
Add the ability for Ajax to work over secure
connection (SSL/TLS) with Cross-origin resource sharing (CORS).
*** requires Django and Tastypie ***
Thanks to: DjangoProject.com and Tastypie
Orginal Code Author: Unknown
"""
